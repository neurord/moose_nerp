...
def create_model_sim(model,fname,param_sim,plotcomps):
    ...
    ####### Set up stimulation
    neuron_paths = {ntype:[neur.path] for ntype, neur in neurons.items()}
    print('neurons',neurons,'neuron_paths',neuron_paths)
    ...
    return syn,neurons,pg,param_sim,writer,vmtab, catab, plastab, currtab
