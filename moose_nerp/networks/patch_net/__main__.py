...
from moose_nerp.networks import patch_net as net
from moose_nerp.graph import net_graph, neuron_graph, spine_graph

#names of additional neuron modules to import
##### !!!!!!!!!!! CHANGE TO 'd2opt' WHEN THAT optimized D2 neuron available
#neuron_modules=['d1d2']
neuron_modules=['cells.d2patch'] #d2patch has hand-tuned d2 patch neuron.  Use this as starting point for optimization
...
param_sim.simtime = 1.0#2.5#.003#.#21
net.num_inject = 0
if net.num_inject==0:
