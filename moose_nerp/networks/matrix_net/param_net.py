...
D1pop=neur_distr(neuronname='D1', spacing=grid,percent=0.5)
D2pop=neur_distr(neuronname='D2', spacing=grid,percent=0.5)
...
tt_Ctx_SPN = TableSet('CtxSPN', './Ctx10000_osc_freq10.0_osc0.7',syn_per_tt=10) #4 for single
#tt_Thal_SPN = TableSet('ThalSPN', 'Thal_4x4',syn_per_tt=2)
tt_FSI_SPN = TableSet('FSISPN','./FSI1000_osc_freq20.0_osc0.7',syn_per_tt=16)
...
D1['ampa'] = {'extern1': ctx_D1post,
              #'extern2': thal_D1post
             }
D1['gaba'] = {'FSIextern': FSIextern_D1post,
              'LTSIextern': LTSIextern_D1post,
              'D1': D1pre_D1post, 'D2': D2pre_D1post
             }
...
D2['gaba']={'FSIextern': FSIextern_D2post,
            'LTSIextern': LTSIextern_D2post,
            'D1': D1pre_D2post, 'D2': D2pre_D2post
             }
connect_dict['D2']=D2
