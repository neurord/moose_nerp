...
Na_m_params = TauInfMinChannelParams(T_min=7.302057871488773e-05,
 T_vdep=0.0015352576674805146,
 T_vhalf=-0.06423223658339572,
 T_vslope=0.008,
 SS_min=0.0,
 SS_vdep=1.0,
 SS_vhalf=-0.027232236583395724,
 SS_vslope=-0.01,
 T_power=2)

Na_h_params = TauInfMinChannelParams(T_min=0.00036914149765158934,
 T_vdep=0.00160845968475638,
 T_vhalf=-0.03162199480089638,
 T_vslope=0.003,
 SS_min=0.0,
 SS_vdep=1.0,
 SS_vhalf=-0.04962199480089638,
 SS_vslope=0.006,
 T_power=1)
...
Kir_X_params = AlphaBetaChannelParams(A_rate=0.003945861279333359,
 A_B=0.0,
 A_C=0.0,
 A_vhalf=-0.00030095882408308003,
 A_vslope=0.011,
 B_rate=493.23265991666983,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=-0.040300958824083084,
 B_vslope=-0.04)
...
qfactKaF = 2
KaF_X_params = AlphaBetaChannelParams(A_rate=2393.051572393769,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=0.012865244209722633,
 A_vslope=-0.013,
 B_rate=598.2628930984423,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=-0.007134755790277366,
 B_vslope=0.011)
...
KaF_Y_params = AlphaBetaChannelParams(A_rate=196.4612517716247,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=0.12890440696942546,
 A_vslope=0.022,
 B_rate=121.6188701443391,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.06290440696942548,
 B_vslope=-0.011)
...
KaS_X_params = AlphaBetaChannelParams(A_rate=49559.48804950096,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.10516699505662751,
 A_vslope=-0.0162951634,
 B_rate=781961924.7658447,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.38095153874337245,
 B_vslope=0.0218235302)

KaS_Y_params = AlphaBetaChannelParams(A_rate=45556412.82228481,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=1.2233155948481103,
 A_vslope=0.0645391447,
 B_rate=2.290733656700401,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.0019511976501101892,
