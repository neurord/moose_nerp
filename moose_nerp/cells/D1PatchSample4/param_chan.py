...
Na_m_params = TauInfMinChannelParams(T_min=0.0002562576220838276,
 T_vdep=0.005387816504312476,
 T_vhalf=-0.0626506774862719,
 T_vslope=0.008,
 SS_min=0.0,
 SS_vdep=1.0,
 SS_vhalf=-0.02565067748627191,
 SS_vslope=-0.01,
 T_power=2)

Na_h_params = TauInfMinChannelParams(T_min=0.0007973822448933904,
 T_vdep=0.003474432439622615,
 T_vhalf=-0.031208873393314462,
 T_vslope=0.003,
 SS_min=0.0,
 SS_vdep=1.0,
 SS_vhalf=-0.04920887339331446,
 SS_vslope=0.006,
 T_power=1)
...
Kir_X_params = AlphaBetaChannelParams(A_rate=0.011109353517517403,
 A_B=0.0,
 A_C=0.0,
 A_vhalf=0.023396510225408854,
 A_vslope=0.011,
 B_rate=1388.6691896896752,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=-0.01660348977459115,
 B_vslope=-0.04)
...
qfactKaF = 2
KaF_X_params = AlphaBetaChannelParams(A_rate=2070.9652973671587,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=0.0371335670947988,
 A_vslope=-0.013,
 B_rate=517.7413243417897,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.017133567094798803,
 B_vslope=0.011)
...
KaF_Y_params = AlphaBetaChannelParams(A_rate=361.9877267060535,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=0.14737011802100977,
 A_vslope=0.022,
 B_rate=224.08764034184264,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.0813701180210098,
 B_vslope=-0.011)
...
KaS_X_params = AlphaBetaChannelParams(A_rate=93742.41354797517,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.1073634202257022,
 A_vslope=-0.0162951634,
 B_rate=1479091108.7893813,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.37875511357429775,
 B_vslope=0.0218235302)

KaS_Y_params = AlphaBetaChannelParams(A_rate=75064548.34816468,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=1.2299034882363913,
 A_vslope=0.0645391447,
 B_rate=3.7745045466363236,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.008539091038391247,
