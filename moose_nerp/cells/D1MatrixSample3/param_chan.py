...
Na_m_params = TauInfMinChannelParams(T_min=0.0002040863876070645,
 T_vdep=0.004290916299438531,
 T_vhalf=-0.06706620715529588,
 T_vslope=0.008,
 SS_min=0.0,
 SS_vdep=1.0,
 SS_vhalf=-0.030066207155295878,
 SS_vslope=-0.01,
 T_power=2)

Na_h_params = TauInfMinChannelParams(T_min=0.0004895730095139676,
 T_vdep=0.002133215727729706,
 T_vhalf=-0.020725869831994714,
 T_vslope=0.003,
 SS_min=0.0,
 SS_vdep=1.0,
 SS_vhalf=-0.038725869831994705,
 SS_vslope=0.006,
 T_power=1)
...
Kir_X_params = AlphaBetaChannelParams(A_rate=0.02972020009390679,
 A_B=0.0,
 A_C=0.0,
 A_vhalf=0.01571299942723097,
 A_vslope=0.011,
 B_rate=3715.0250117383484,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=-0.02428700057276903,
 B_vslope=-0.04)
...
qfactKaF = 2
KaF_X_params = AlphaBetaChannelParams(A_rate=7821.013198852427,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=0.020649856160438757,
 A_vslope=-0.013,
 B_rate=1955.2532997131068,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.0006498561604387589,
 B_vslope=0.011)
...
KaF_Y_params = AlphaBetaChannelParams(A_rate=161.5427764371667,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=0.14194453388935138,
 A_vslope=0.022,
 B_rate=100.00267112776987,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.0759445338893514,
 B_vslope=-0.011)
...
KaS_X_params = AlphaBetaChannelParams(A_rate=79237.04645368528,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.10399283934365142,
 A_vslope=-0.0162951634,
 B_rate=1250221820.2051888,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.38212569445634853,
 B_vslope=0.0218235302)

KaS_Y_params = AlphaBetaChannelParams(A_rate=11825207.916560022,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=1.2281042617798579,
 A_vslope=0.0645391447,
 B_rate=0.5946122640870716,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.0067398645818579,
