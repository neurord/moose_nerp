...
from moose_nerp.cells import Npas2003 as model
...
model.param_sim.fname=str(neurtype)+'2003_alcohol'+str(alcohol)+'_inject'
...
'''
wavemodule='gpedata_experimental'    
dataname='Npas2003-2s'
waveset=[0,2,4]

import plot_opt_waves
plot_opt_waves.plot_opt_waves(wavemodule,dataname,waveset)
