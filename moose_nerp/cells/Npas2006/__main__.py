...
from moose_nerp.cells import Npas2006 as model
...
fildir='fitgp-Npas-cmaes_Npas2006_84362_24/tmp2x3fk6xs'
dat=np.load('/home/avrama/moose/opt_output/gp_opt/NSG_output_chan2019nov13/'+fildir+'/ivdata-0.0.npy','r')
plotdt=model.param_sim.plotdt
simtime=model.param_sim.simtime
simtime=len(dat)*plotdt
