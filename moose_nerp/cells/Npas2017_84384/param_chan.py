...
Na_m_params = AlphaBetaChannelParams(A_rate=13597.87526895899,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.04295035307902845,
 A_vslope=-0.005,
 B_rate=13597.87526895899,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.04295035307902845,
 B_vslope=0.005)

Na_h_params = AlphaBetaChannelParams(A_rate=3382.8697428950095,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.07532141991708474,
 A_vslope=0.009,
 B_rate=3382.8697428950095,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.035321419917084734,
 B_vslope=-0.005)
'''
...
NaS_m_params = AlphaBetaChannelParams(A_rate=76e3,
                                    ...
                                    B_rate=70e3,
                                     ...
                                     B_vslope=13.5e-3)
'''
NaS_m_params = AlphaBetaChannelParams(A_rate=23297.364958134025,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.05418226128363404,
 A_vslope=-0.027,
 B_rate=23297.364958134025,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.13621773871636597,
 B_vslope=0.0262)

NaS_h_params = AlphaBetaChannelParams(A_rate=57.56500772755632,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.053230908429494864,
 A_vslope=0.0045,
 B_rate=53.96719474458405,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.05223090842949486,
 B_vslope=-0.004)
...
Kv3_X_params = AlphaBetaChannelParams(A_rate=6521.804615419998,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.02312748951459799,
 A_vslope=-0.015,
 B_rate=8869.654276971198,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.08787251048540201,
 B_vslope=0.015)

Kv3_Y_params = TauInfMinChannelParams(T_min=0.006747537037052772,
 T_vdep=0.02506228042333887,
 T_vhalf=0.004348133020473788,
 T_vslope=0.01,
 SS_min=0.6,
 SS_vdep=0.4,
 SS_vhalf=-0.01565186697952621,
 SS_vslope=0.01,
 T_power=1)
...
KvF_X_params = AlphaBetaChannelParams(A_rate=2268.0379872770477,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.036987124262761094,
 A_vslope=-0.026,
 B_rate=2268.0379872770477,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.1250128757372389,
 B_vslope=0.027)

KvF_Y_params = AlphaBetaChannelParams(A_rate=140.05071802257515,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.09312250035266864,
 A_vslope=0.012,
 B_rate=132.5813463947045,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.06812250035266865,
 B_vslope=-0.012)
...
KvS_X_params = AlphaBetaChannelParams(A_rate=5328.115639873728,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.03819333502193563,
 A_vslope=-0.022,
 B_rate=2103.2035420554184,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.09180666497806438,
 B_vslope=0.02)

KvS_Y_params = AlphaBetaChannelParams(A_rate=38.567973936347805,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.0929028501530524,
 A_vslope=0.01,
 B_rate=40.59786730141874,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.0779028501530524,
 B_vslope=-0.012)
...
HCN1_X_params = AlphaBetaChannelParams(A_rate=203.4199199950608,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.1344470954999374,
 A_vslope=0.01,
 B_rate=88.14863199785968,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.01444709549993743,
 B_vslope=-0.012)
HCN1_Y_params=[]

HCN2param = ChannelSettings(Xpow=1, Ypow=0, Zpow=0, Erev=hcnrev, name='HCN2')

HCN2_X_params = AlphaBetaChannelParams(A_rate=20.981778792131742,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.15217314847187705,
 A_vslope=0.01,
 B_rate=13.987852528087828,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.032173148471877036,
 B_vslope=-0.012)
HCN2_Y_params=[]

#Caparam - D.James Surmeier, ( tau and ss)
Caparam=ChannelSettings(Xpow=1 , Ypow=0 , Zpow=0, Erev=carev , name='Ca')
Ca_X_params = AlphaBetaChannelParams(A_rate=384093.3073210522,
 A_B=-5274586.6866746135,
 A_C=-1,
 A_vhalf=-0.07281960277407167,
 A_vslope=-0.011,
 B_rate=870.3068024310044,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.006180397225928336,
 B_vslope=0.013)
Ca_Y_params=[]
