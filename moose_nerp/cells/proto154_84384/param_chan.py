...
Na_m_params = AlphaBetaChannelParams(A_rate=29244.37329413202,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.03872328801316653,
 A_vslope=-0.005,
 B_rate=29244.37329413202,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.03872328801316653,
 B_vslope=0.005)

Na_h_params = AlphaBetaChannelParams(A_rate=8787.051651729702,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.08260954921923173,
 A_vslope=0.009,
 B_rate=8787.051651729702,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.042609549219231733,
 B_vslope=-0.005)
'''
...
NaS_m_params = AlphaBetaChannelParams(A_rate=76e3,
                                    ...
                                    B_rate=70e3,
                                     ...
                                     B_vslope=13.5e-3)
'''
NaS_m_params = AlphaBetaChannelParams(A_rate=30732.45568048877,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.0639110481338315,
 A_vslope=-0.027,
 B_rate=30732.45568048877,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.12648895186616851,
 B_vslope=0.0262)

NaS_h_params = AlphaBetaChannelParams(A_rate=40.14470951103033,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.0530132378928497,
 A_vslope=0.0045,
 B_rate=37.63566516659093,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.0520132378928497,
 B_vslope=-0.004)
...
Kv3_X_params = AlphaBetaChannelParams(A_rate=10857.32112809091,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.0233229612469857,
 A_vslope=-0.015,
 B_rate=14765.956734203639,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.0876770387530143,
 B_vslope=0.015)

Kv3_Y_params = TauInfMinChannelParams(T_min=0.006521629106946672,
 T_vdep=0.024223193825801924,
 T_vhalf=0.0020108598435844803,
 T_vslope=0.01,
 SS_min=0.6,
 SS_vdep=0.4,
 SS_vhalf=-0.01798914015641552,
 SS_vslope=0.01,
 T_power=1)
...
KvF_X_params = AlphaBetaChannelParams(A_rate=4109.838956489031,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.02685751551580827,
 A_vslope=-0.026,
 B_rate=4109.838956489031,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.13514248448419172,
 B_vslope=0.027)

KvF_Y_params = AlphaBetaChannelParams(A_rate=175.1042331298712,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.10421549572547273,
 A_vslope=0.012,
 B_rate=165.76534069627806,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.07921549572547273,
 B_vslope=-0.012)
...
KvS_X_params = AlphaBetaChannelParams(A_rate=4093.365808636151,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.026968280878119658,
 A_vslope=-0.022,
 B_rate=1615.8022928826913,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.10303171912188035,
 B_vslope=0.02)

KvS_Y_params = AlphaBetaChannelParams(A_rate=40.444501264671416,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.09019376333890569,
 A_vslope=0.01,
 B_rate=42.57315922596992,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.0751937633389057,
 B_vslope=-0.012)
...
HCN1_X_params = AlphaBetaChannelParams(A_rate=225.41689525857555,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.1421990433668832,
 A_vslope=0.01,
 B_rate=97.68065461204941,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.022199043366883185,
 B_vslope=-0.012)
HCN1_Y_params=[]

HCN2param = ChannelSettings(Xpow=1, Ypow=0, Zpow=0, Erev=hcnrev, name='HCN2')

HCN2_X_params = AlphaBetaChannelParams(A_rate=16.724285927260993,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.122167408129915,
 A_vslope=0.01,
 B_rate=11.14952395150733,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.0021674081299149876,
 B_vslope=-0.012)
HCN2_Y_params=[]

#Caparam - D.James Surmeier, ( tau and ss)
Caparam=ChannelSettings(Xpow=1 , Ypow=0 , Zpow=0, Erev=carev , name='Ca')
Ca_X_params = AlphaBetaChannelParams(A_rate=375199.5981733965,
 A_B=-5070795.831301069,
 A_C=-1,
 A_vhalf=-0.07399225105009355,
 A_vslope=-0.011,
 B_rate=836.6813113279951,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.0050077489499064515,
 B_vslope=0.013)
Ca_Y_params=[]
