...
Na_m_params = AlphaBetaChannelParams(A_rate=39979.59540206964,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.032277171163183904,
 A_vslope=-0.005,
 B_rate=39979.59540206964,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.032277171163183904,
 B_vslope=0.005)

Na_h_params = AlphaBetaChannelParams(A_rate=6152.331550643798,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.06733805249517075,
 A_vslope=0.009,
 B_rate=6152.331550643798,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.027338052495170746,
 B_vslope=-0.005)
'''
...
NaS_m_params = AlphaBetaChannelParams(A_rate=76e3,
                                    ...
                                    B_rate=70e3,
                                     ...
                                     B_vslope=13.5e-3)
'''
NaS_m_params = AlphaBetaChannelParams(A_rate=35202.16027872059,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.05660052778870013,
 A_vslope=-0.027,
 B_rate=35202.16027872059,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.13379947221129987,
 B_vslope=0.0262)

NaS_h_params = AlphaBetaChannelParams(A_rate=20.85841992741283,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.06501910970273456,
 A_vslope=0.0045,
 B_rate=19.554768681949525,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.06401910970273456,
 B_vslope=-0.004)
...
Kv3_X_params = AlphaBetaChannelParams(A_rate=5646.019859958073,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.029852775061819332,
 A_vslope=-0.015,
 B_rate=7678.587009542978,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.08114722493818066,
 B_vslope=0.015)

Kv3_Y_params = TauInfMinChannelParams(T_min=0.0143034216972371,
 T_vdep=0.05312699487545209,
 T_vhalf=-0.0007577551611962843,
 T_vslope=0.01,
 SS_min=0.6,
 SS_vdep=0.4,
 SS_vhalf=-0.020757755161196285,
 SS_vslope=0.01,
 T_power=1)
...
KvF_X_params = AlphaBetaChannelParams(A_rate=3013.423783656704,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.029899436407460622,
 A_vslope=-0.026,
 B_rate=3013.423783656704,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.13210056359253938,
 B_vslope=0.027)

KvF_Y_params = AlphaBetaChannelParams(A_rate=135.8351993767611,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.09696621622766956,
 A_vslope=0.012,
 B_rate=128.5906554100005,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.07196621622766956,
 B_vslope=-0.012)
...
KvS_X_params = AlphaBetaChannelParams(A_rate=8515.518761011654,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.026200738132816682,
 A_vslope=-0.022,
 B_rate=3361.3889846098637,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.10379926186718333,
 B_vslope=0.02)

KvS_Y_params = AlphaBetaChannelParams(A_rate=44.23862698476318,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.10191439358134415,
 A_vslope=0.01,
 B_rate=46.566975773434926,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.08691439358134415,
 B_vslope=-0.012)
...
HCN1_X_params = AlphaBetaChannelParams(A_rate=60.797019330053956,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.15879374129546878,
 A_vslope=0.01,
 B_rate=26.34537504302338,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.03879374129546879,
 B_vslope=-0.012)
HCN1_Y_params=[]

HCN2param = ChannelSettings(Xpow=1, Ypow=0, Zpow=0, Erev=hcnrev, name='HCN2')

HCN2_X_params = AlphaBetaChannelParams(A_rate=21.435897753156098,
 A_B=0.0,
 A_C=1,
 A_vhalf=0.14069269717775598,
 A_vslope=0.01,
 B_rate=14.290598502104066,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.02069269717775598,
 B_vslope=-0.012)
HCN2_Y_params=[]

#Caparam - D.James Surmeier, ( tau and ss)
Caparam=ChannelSettings(Xpow=1 , Ypow=0 , Zpow=0, Erev=carev , name='Ca')
Ca_X_params = AlphaBetaChannelParams(A_rate=168381.8635813998,
 A_B=-2311877.3683003467,
 A_C=-1,
 A_vhalf=-0.0728333889548784,
 A_vslope=-0.011,
 B_rate=381.4597653880974,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.006166611045121607,
 B_vslope=0.013)
Ca_Y_params=[]
