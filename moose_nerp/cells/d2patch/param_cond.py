...
_D2 = _util.NamedDict(
    ...
    KaS = {prox:322, med: 32.9, dist: 0}, #patch d2?
    ...
    CaR = {prox:40*ghKluge, med: 45*ghKluge, dist: 45*ghKluge}, #patch d2?
...
######## Continue to lower KaS and raise CaR to create patch D2.
### Get data from Josh to begin optimizations?
### one sim worked, the other didn't, too much depolarization.
### spatiotemporal mapping for upstates.
