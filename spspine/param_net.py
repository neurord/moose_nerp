...
####################### Connections
connect=NamedList('connect','synapse pre post space_const')# add num_post_connect post_location?
#possible have a different NamedList for external connections?
ext_connect=NamedList('ext_connect','synapse pre post fraction_duplicate filename num_post_connect')
...
#glu_D1post=connect(synapse='ampa',pre='timetable',post='D1', fraction_duplicate=0.1)
#glu_D2post=connect(synapse='ampa',pre='timetable',post='D2', fraction_duplicate=0.1)
