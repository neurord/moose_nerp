...
Na_m_params = AlphaBetaChannelParams(A_rate = 55e3,
                                      A_B = 0,
                                      A_C = 1,
                                      Avhalf = 35e-3,
                                      A_vslope = -5e-3,
...
Na_h_params = AlphaBetaChannelParams(A_rate = 4e3,
                                      A_B = 0,
                                      A_C = 1,
                                      Avhalf = 72e-3,
                                      A_vslope = 9e-3,
...
Kv3_X_params = AlphaBetaChannelParams(A_rate = 5e3,
                                      A_B = 0,
                                      A_C = 1,
                                      Avhalf = -30e-3,
                                      A_vslope =-10e-3,
...
KvF_X_params = AlphaBetaChannelParams(A_rate = 3.6e3,
                                      A_B = 0,
                                      A_C = 1,
                                      Avhalf = -30e-3,
                                      A_vslope = -22.0e-3,
