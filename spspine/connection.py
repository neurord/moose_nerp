#0. debug CorrTrains (and rename to corr_trains.py), then debug external connections
#      possibly call this from SPnetSim.py?
#      aternatively, eliminate check_connect, and provide num_tt or num_postsyn as additional arguments
