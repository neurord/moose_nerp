...
CaMN_params=cabuf_params(bufname='CaMN',kf=0.1e6,kb=1e3,difconst=66e-12,total=15e-3,bound=3e-3)
CaMC_params=cabuf_params(bufname='CaMC',kf=0.006e6,kb=9.1,difconst=66e-12,total=15e-3,bound=3e-3)
